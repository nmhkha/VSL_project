...
dir_name = "y" # directory name that we want to use as the label of images -> ex. dir_name = f
data_dir = f"./vsl_dataset/{dir_name}" # fill 'dir_name' to collect your own data
